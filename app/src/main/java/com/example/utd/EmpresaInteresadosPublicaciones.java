...
public class EmpresaInteresadosPublicaciones extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_empresa_interesados_publicaciones);
        ...
        tvpcorreo = findViewById(R.id.tvepCorreoN);

        listV = findViewById(R.id.listVacantesN);

        searchView =  findViewById(R.id.txbusquedaPI);
        ...
        listV.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getApplicationContext(), InteresadosActivity.class);
        ...
        databaseReference.child(nodoF).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot objdataSnapshot : snapshot.getChildren()) {
                    ...
                    listviewvacantesAdapter = new AdapterPublicaciones(EmpresaInteresadosPublicaciones.this, listVacantes);
