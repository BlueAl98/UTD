...
public class AdapterPublicaciones extends BaseAdapter {
    ...
    public AdapterPublicaciones(Context context, ArrayList<VacantesResi> vacantesResis) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null){
            rowView = layoutInflater.inflate(R.layout.activity_modelpublicacion,null,true);
        ...
        TextView titulo = rowView.findViewById(R.id.tvTituloM);
        TextView carrera = rowView.findViewById(R.id.tvCarreraM);
